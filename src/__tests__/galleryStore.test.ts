...
import { GalleryStore } from '../main';
import type { Frame, GalleryState } from '../main';

describe('GalleryStore', () => {
  const mockFrames: Frame[] = [
    { id: '1', src: 'image1.jpg', thumb: 'thumb1.jpg', caption: 'Image 1', video: null, html: null },
    { id: '2', src: 'image2.jpg', thumb: 'thumb2.jpg', caption: 'Image 2', video: null, html: null },
    { id: '3', src: 'image3.jpg', thumb: 'thumb3.jpg', caption: 'Image 3', video: null, html: null },
  ];
